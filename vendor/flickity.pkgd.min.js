...
(function (t, e) {
  ...
  function x (t) {
    if (
      ...
      for (var n = (i.isBorderBox = e.boxSizing == 'border-box'), s = 0; s < b; s++) {
        var o = y[s];
      ...
      var u = i.borderLeftWidth + i.borderRightWidth;
    ...
    (c.htmlInit = function (a, l) {
      c.docReady(function () {
        ...
        n.forEach(function (e) {
          ...
          var i = e.getAttribute(s) || e.getAttribute(o);
          try {
            t = i && JSON.parse(i);
          } catch (t) {
            return void (
              d && d.error('Error parsing ' + s + ' on ' + e.className + ': ' + t)
            );
          }
          var n = new a(e, t);
          r && r.data(e, l, n);
  ...
  var i = {
    ...
    applySelectedAttraction: function () {
      if (
        ...
        var t =
            (-1 * this.selectedSlide.target - this.x) * this.options.selectedAttraction;
        this.applyForce(t);
      }
    }
  };
...
(function (r, a) {
  ...
  (p.updateSlides = function () {
    if (((this.slides = []), this.cells.length)) {
      var n = new r(this);
      this.slides.push(n);
      var s = this.originSide == 'left' ? 'marginRight' : 'marginLeft';

      var o = this._getCanCellFit();
  ...
  return (
    ...
    (p._wrapSelect = function (t) {
      ...
      var n = Math.abs(i - this.selectedIndex);

      var s = Math.abs(i + e - this.selectedIndex);

      var o = Math.abs(i - e - this.selectedIndex);
    ...
    (p.selectInitialIndex = function () {
      ...
      if (this.isInitActivated) this.select(this.selectedIndex, !1, !0);
        ...
        if (t && typeof t === 'string') { if (this.queryCell(t)) return void this.selectCell(t, !1, !0); }
        var e = 0;
    ...
    (p.getCellSlideIndex = function (t) {
      for (var e = 0; e < this.slides.length; e++) {
        if (this.slides[e].cells.indexOf(t) != -1) return e;
      }
    }),
    ...
    (p.watchCSS = function () {
      this.options.watchCSS &&
          (o(this.element, ':after').content.indexOf('flickity') != -1
            ? this.activate()
            : this.deactivate());
    }),
...
(function (e, i) {
  ...
  var r = { radio: !0, checkbox: !0, button: !0, submit: !0, image: !0, file: !0 };
  return (
    (i.okayPointerDown = function (t) {
      var e = s[t.target.nodeName];

      var i = r[t.target.type];
    ...
    (i._staticClick = function (t, e) {
      (this.isIgnoringMouseUp && t.type == 'mouseup') ||
  ...
  return (
    ...
    (n._getClosestResting = function (t, e, i) {
      for (
        ...
        o(e, s) && ((n += i), (s = e), (e = this.getSlideDistance(-t, n)) !== null);
...
(function (i, n) {
  typeof define === 'function' && define.amd
    ? define('flickity/js/lazyload', ['./flickity', 'fizzy-ui-utils/utils'], function (
      t,
      e
    ) {
      return n(i, t, e);
...
(function (e, i) {
  ...
  function l (t, e, i) {
    ...
    n
      ...
      typeof e === 'function' ? (i = e) : r(this.options, e),
      i && this.on('always', i),
      this.getImages(),
